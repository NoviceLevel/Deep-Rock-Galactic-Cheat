...
// bool                                    Downloading_0                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UHUD_Modding_Downloads_C::OnDownloadProgress(const class FString& Name_0, const TArray<class FString>& ModsPendingDownload, bool Downloading_0, int32 Progress, int32 Total)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Downloading_0 = Downloading_0;
...
void UHUD_Modding_Downloads_C::PreConstruct(bool IsDesignTime_0)
{
	static class UFunction* Func = nullptr;
...
void UHUD_Modding_Downloads_C::SetDownloadProgress(const class FString& Name_0, const TArray<class FString>& ModsPendingDownload, bool Downloading_0, int32 Progress, int32 Total)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const TMap<class FString, EUGCPackageError>&InFailed                                               (BlueprintVisible, BlueprintReadOnly, Parm)
