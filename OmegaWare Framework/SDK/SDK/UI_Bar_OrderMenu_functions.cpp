...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class ASpaceRigBar*                     BarActor_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUI_Bar_OrderMenu_C::SetBartender(class ASpaceRigBar* BarActor_0)
{
	static class UFunction* Func = nullptr;
