...
void UBasic_OptionSwitcher_C::Set_Options(TArray<class FText>& options_0, int32 DefaultIndex)
{
	static class UFunction* Func = nullptr;
...
void UBasic_OptionSwitcher_C::GetSelectedIndex(int32* Index_0)
{
	static class UFunction* Func = nullptr;
...
void UBasic_OptionSwitcher_C::Add_Option(const class FText& Option, int32* Index_0)
{
	static class UFunction* Func = nullptr;
