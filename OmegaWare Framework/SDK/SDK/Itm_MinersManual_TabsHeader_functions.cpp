...
// Parameters:
// class U_MENU_MinersManual_C*            _Menu_Lore_0                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UItm_MinersManual_TabsHeader_C::SetData(class U_MENU_MinersManual_C* _Menu_Lore_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms._Menu_Lore_0 = _Menu_Lore_0;
...
void UItm_MinersManual_TabsHeader_C::SetSelected(int32 Index_0, const class FText& HeaderText)
{
	static class UFunction* Func = nullptr;
