...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UMinersManualData*                Data_0                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ULore_Container_Text_W_Image_C::SetData(class UMinersManualData* Data_0)
{
	static class UFunction* Func = nullptr;
