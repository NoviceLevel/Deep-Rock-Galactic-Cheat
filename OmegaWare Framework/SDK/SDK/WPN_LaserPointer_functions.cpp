...
void AWPN_LaserPointer_C::OnMarkerPlaced_Event(const struct FVector& Location, const class FText& Name_0, const struct FLinearColor& Color, class AActor* Target, ELaserPointerTargetType TypeOfTarget)
{
	static class UFunction* Func = nullptr;
