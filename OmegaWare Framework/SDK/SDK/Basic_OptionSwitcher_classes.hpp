...
public:
	...
	TMulticastInlineDelegate<void(class FText Value, int32 Index)> OnSelectionChanged;               // 0x02A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void Set_Options(TArray<class FText>& options_0, int32 DefaultIndex);
	...
	void Add_Option(const class FText& Option, int32* Index_0);
	void ClearOptions();
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Basic_OptionSwitcher_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Basic_OptionSwitcher_C")
	}
...
DUMPER7_ASSERTS_UBasic_OptionSwitcher_C;
