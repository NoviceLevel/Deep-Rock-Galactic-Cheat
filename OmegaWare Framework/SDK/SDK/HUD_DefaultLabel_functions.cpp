...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// ENUM_AcuminCondensedTypeface            Typeface_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UHUD_DefaultLabel_C::SetTypeFace(ENUM_AcuminCondensedTypeface Typeface_0)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FFontOutlineSettings&      InFontInfo_OutlineSettings                             (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
