...
// Parameters:
// class UWidget*                          Owner_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBiome_ToolTip_C::Set_Tool_Tip_Owner(class UWidget* Owner_0)
{
	static class UFunction* Func = nullptr;
