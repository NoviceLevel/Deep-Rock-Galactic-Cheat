...
void ULIB_Game_UI_C::GetEnemyFamilyInfo(EEnemyFamily Family, class UObject* __WorldContext, class FText* Name_0, class UTexture2D** Icon, struct FLinearColor* Color)
{
	static class UFunction* Func = nullptr;
...
void ULIB_Game_UI_C::GetEnemyFamilyName(EEnemyFamily Family, class UObject* __WorldContext, class FText* Name_0)
{
	static class UFunction* Func = nullptr;
