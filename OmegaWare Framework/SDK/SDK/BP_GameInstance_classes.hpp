...
public:
	...
	TMulticastInlineDelegate<void(TArray<TScriptInterface<class ICraftable>>& NewItems)> OnAvailableCraftingItems; // 0x0B78(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(class UBP_GameInstance_C* GameInstance)> OnEligibleForRetirementAssignment; // 0x0B90(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
