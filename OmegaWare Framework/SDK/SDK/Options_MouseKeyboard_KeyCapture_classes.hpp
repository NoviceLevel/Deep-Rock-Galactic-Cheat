...
public:
	...
	TMulticastInlineDelegate<void()>              OnKeyCaptureFinished;                              // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void()>              OnKeyCaptureError;                                 // 0x02D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void()>              OnKeyCaptureChanged;                               // 0x02E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void()>              OnKeyCaptureCancelled;                             // 0x02F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Options_MouseKeyboard_KeyCapture_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Options_MouseKeyboard_KeyCapture_C")
	}
...
DUMPER7_ASSERTS_UOptions_MouseKeyboard_KeyCapture_C;
