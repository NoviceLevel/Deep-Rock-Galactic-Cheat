...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UProgressBar*                     HealthBar_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                                   InPercent                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UHUD_EnemyTargeting_HealthBar_C::SetHealthMapped(class UProgressBar* HealthBar_0, float InPercent)
{
	static class UFunction* Func = nullptr;
