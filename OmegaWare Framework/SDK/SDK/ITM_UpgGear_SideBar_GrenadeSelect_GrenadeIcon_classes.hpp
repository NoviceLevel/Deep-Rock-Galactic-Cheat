...
public:
	...
	TMulticastInlineDelegate<void(class UItemID* itemClass)> ItemEquipped;                           // 0x02B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(class UITM_UpgGear_SideBar_GrenadeSelect_GrenadeIcon_C* Widget, bool IsUnlocked)> ItemHovered; // 0x02D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UITM_UpgGear_SideBar_GrenadeSelect_GrenadeIcon_C* Widget)> ItemUnhovered; // 0x02E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UITM_UpgGear_SideBar_GrenadeSelect_GrenadeIcon_C* GrenadeWidget)> ItemTryPurchase; // 0x02F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void GetGrenadeInfo(class FText* Name_0, class FText* Description);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("ITM_UpgGear_SideBar_GrenadeSelect_GrenadeIcon_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"ITM_UpgGear_SideBar_GrenadeSelect_GrenadeIcon_C")
	}
...
DUMPER7_ASSERTS_UITM_UpgGear_SideBar_GrenadeSelect_GrenadeIcon_C;
