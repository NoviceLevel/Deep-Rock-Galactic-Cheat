...
// const struct FGuid&                     ID                                                     (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_PlayerController_SpaceRig_C::OnCharacterPossesd(class APawn* Pawn_0)
{
	static class UFunction* Func = nullptr;
...
void ABP_PlayerController_SpaceRig_C::InpActEvt_Ctrl_Alt_H_K2Node_InputKeyEvent_1(const struct FKey& Key)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_PlayerController_SpaceRig_C_InpActEvt_Ctrl_Alt_H_K2Node_InputKeyEvent_1 Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    IsHUDVisible_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
void ABP_PlayerController_SpaceRig_C::ChangeHUDVisible(bool IsHUDVisible_0, EHUDVisibilityReason reason)
{
	static class UFunction* Func = nullptr;
	...
	Parms.IsHUDVisible_0 = IsHUDVisible_0;
	Parms.reason = reason;
