...
void ABP_DropPod_Base_C::SetPreferredCharacter(class UChildActorComponent* Spawn, class UPlayerCharacterID* Class_0)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EDroppodDoorState                       DoorState_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_DropPod_Base_C::SetDoorState(EDroppodDoorState DoorState_0)
{
	static class UFunction* Func = nullptr;
