...
// BlueprintGeneratedClass Tutorial_Hint_DeepScan_MorkiteSeed_Bosco.Tutorial_Hint_DeepScan_MorkiteSeed_Bosco_C
// 0x0028 (0x0198 - 0x0170)
class UTutorial_Hint_DeepScan_MorkiteSeed_Bosco_C final : public UTutorialHintComponent
{
public:
...
public:
	void ExecuteUbergraph_Tutorial_Hint_DeepScan_MorkiteSeed_Bosco(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Tutorial_Hint_DeepScan_MorkiteSeed_Bosco_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Tutorial_Hint_DeepScan_MorkiteSeed_Bosco_C")
	}
	static class UTutorial_Hint_DeepScan_MorkiteSeed_Bosco_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTutorial_Hint_DeepScan_MorkiteSeed_Bosco_C>();
	}
};
DUMPER7_ASSERTS_UTutorial_Hint_DeepScan_MorkiteSeed_Bosco_C;
