...
// Parameters:
// struct FLinearColor*                    ColorAndOpacity_0                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UITM_Overclock_Icon_C::GetFrameLinearColor(struct FLinearColor* ColorAndOpacity_0)
{
	static class UFunction* Func = nullptr;
	...
	if (ColorAndOpacity_0 != nullptr)
		*ColorAndOpacity_0 = std::move(Parms.ColorAndOpacity_0);
}
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UItemUpgrade*                     Overclock_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UITM_Overclock_Icon_C::SetOverclockTooltip(class UItemUpgrade* Overclock_0)
{
	static class UFunction* Func = nullptr;
