...
// Function Modio.ModioCommonTypesLibrary.IntToModID
// (Final, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
...
struct FModioModID UModioCommonTypesLibrary::IntToModID(int64 ModId)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("ModioCommonTypesLibrary", "IntToModID");

	Params::ModioCommonTypesLibrary_IntToModID Parms{};
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// const struct FModioErrorCode&           Error                                                  (ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString                           ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UModioSubsystem::K2_GetTermsOfUseAsync(EModioLanguage Locale, TDelegate<void(const struct FModioErrorCode& ErrorCode, const struct FModioOptionalTerms& Terms)> Callback)
{
	static class UFunction* Func = nullptr;
...
// Function Modio.ModioSubsystem.K2_GetTermsOfUseAsync_DEPRECATED
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// EModioAuthenticationProvider            Provider                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EModioLanguage                          Locale                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UModioSubsystem::K2_GetTermsOfUseAsync_DEPRECATED(EModioAuthenticationProvider Provider, EModioLanguage Locale, TDelegate<void(const struct FModioErrorCode& ErrorCode, const struct FModioOptionalTerms& Terms)> Callback)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ModioSubsystem", "K2_GetTermsOfUseAsync_DEPRECATED");

	Params::ModioSubsystem_K2_GetTermsOfUseAsync_DEPRECATED Parms{};
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// TDelegate<void(const struct FModioErrorCode& ErrorCode, const struct FModioOptionalMapPreview& ModioPreviewMap)>OnPreviewDone                                          (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
