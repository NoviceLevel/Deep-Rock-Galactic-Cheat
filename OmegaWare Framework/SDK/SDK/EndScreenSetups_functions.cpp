...
// struct FRandomStream&                   RandStream_0                                           (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor)
// struct FEndScreenMove*                  Selected                                               (Parm, OutParm, HasGetValueTypeHash)

void UEndScreenSetups_C::GetEndScreenMoveSet(bool Survived, class UVictoryPose* VictPose, struct FRandomStream& RandStream_0, struct FEndScreenMove* Selected)
{
	static class UFunction* Func = nullptr;
	...
	Parms.RandStream_0 = std::move(RandStream_0);

	UObject::ProcessEvent(Func, &Parms);

	RandStream_0 = std::move(Parms.RandStream_0);
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const TArray<TSoftObjectPtr<class UAnimSequence>>&TargetArray                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
void UEndScreenSetups_C::LoadVictoryAnims(class UVictoryPose* InputPin, struct FRandomStream& RandStream_0, struct FEndScreenMove* EndScreenMove)
{
	static class UFunction* Func = nullptr;
...
void UEndScreenSetups_C::GetRandomWalkAnim(class UVictoryPose* VicPose, struct FRandomStream& RandStream_0, TSoftObjectPtr<class UAnimSequence>* Walk)
{
	static class UFunction* Func = nullptr;
