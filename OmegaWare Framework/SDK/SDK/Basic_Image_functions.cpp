...
void UBasic_Image_C::GetBrush(struct FSlateBrush* Brush_0)
{
	static class UFunction* Func = nullptr;
...
void UBasic_Image_C::SelectTint(ENUM_MenuColors FALSE_0, ENUM_MenuColors TRUE_0, bool Condition, ENUM_MenuColors* SelectedTint)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const class FText&                      BasicToolTipText_0                                     (BlueprintVisible, BlueprintReadOnly, Parm)
// const struct FVector2D&                 BasicToolTipPosition_0                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FVector2D&                 BasicToolTipAlignment_0                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBasic_Image_C::SetBasicToolTip(const class FText& BasicToolTipText_0, const struct FVector2D& BasicToolTipPosition_0, const struct FVector2D& BasicToolTipAlignment_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.BasicToolTipText_0 = std::move(BasicToolTipText_0);
	Parms.BasicToolTipPosition_0 = std::move(BasicToolTipPosition_0);
	Parms.BasicToolTipAlignment_0 = std::move(BasicToolTipAlignment_0);
