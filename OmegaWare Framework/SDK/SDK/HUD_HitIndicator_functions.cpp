...
// Parameters:
// const TScriptInterface<class IHealth>&  EnemyHealth                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, UObjectWrapper)
...
void UHUD_HitIndicator_C::StartAnimation(int32 Priority_0, float Scale, const struct FLinearColor& Color, bool ShowKillImage)
{
	static class UFunction* Func = nullptr;
