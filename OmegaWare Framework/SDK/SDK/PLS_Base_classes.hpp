...
public:
	...
	TMulticastInlineDelegate<void(int32 pass, EPLS_Passes PLS_Pass)> CompletedGenerationPass;        // 0x04E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void CarveTunnels();
	void GenerateLandscapeFromData(int32 Seed_0, const TArray<struct FRoomNode>& Rooms_0, const TArray<struct FPathObstacle>& Obstacles);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("PLS_Base_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"PLS_Base_C")
	}
