...
void UOptions_NVIDIA_DLSS_Quality_C::BndEvt__Options_NVIDIA_DLSS_Quality_Basic_OptionSwitcher_K2Node_ComponentBoundEvent_0_OnSelectionChanged__DelegateSignature(const class FText& Value, int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
void UOptions_NVIDIA_DLSS_Quality_C::GetDLSSModeName(EUDLSSMode Mode, class FText* Name_0)
{
	static class UFunction* Func = nullptr;
...
void UOptions_NVIDIA_DLSS_Quality_C::IndexToMode(int32 Index_0, EUDLSSMode* Mode)
{
	static class UFunction* Func = nullptr;
...
void UOptions_NVIDIA_DLSS_Quality_C::ModeToIndex(EUDLSSMode Mode, int32* Index_0)
{
	static class UFunction* Func = nullptr;
