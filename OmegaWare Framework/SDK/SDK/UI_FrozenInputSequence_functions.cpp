...
// Parameters:
// const TArray<EThawInputDirection>&      Sequence_0                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// bool                                    First                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UUI_FrozenInputSequence_C::SetupSequence(const TArray<EThawInputDirection>& Sequence_0, bool First)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Sequence_0 = std::move(Sequence_0);
	Parms.First = First;
