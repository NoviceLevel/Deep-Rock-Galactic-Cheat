...
// (BlueprintEvent)
// Parameters:
// class UUserWidget*                      Crosshair_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AWPN_ZipLineGun_C::BndEvt__CrosshairAggregator_K2Node_ComponentBoundEvent_0_CrosshairCreated__DelegateSignature(class UUserWidget* Crosshair_0)
{
	static class UFunction* Func = nullptr;
