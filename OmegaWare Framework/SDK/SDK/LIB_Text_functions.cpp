...
// const class FText&                      DrillerText                                            (BlueprintVisible, BlueprintReadOnly, Parm)
// const class FText&                      GunnerText                                             (BlueprintVisible, BlueprintReadOnly, Parm)
// const class FText&                      ScoutText                                              (BlueprintVisible, BlueprintReadOnly, Parm)
// const class FText&                      EngineerText                                           (BlueprintVisible, BlueprintReadOnly, Parm)
// const class FText&                      BoscoText                                              (BlueprintVisible, BlueprintReadOnly, Parm)
// const class FText&                      NoneText                                               (BlueprintVisible, BlueprintReadOnly, Parm)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
