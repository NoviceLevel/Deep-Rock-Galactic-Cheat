...
// Parameters:
// const struct FClaimableRewardView&      InViewData                                             (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
...
// Parameters:
// class UHorizontalBox**                  EntryBox_0                                             (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUI_ClaimableRewards_View_C::GetLine(class UHorizontalBox** EntryBox_0)
{
	static class UFunction* Func = nullptr;
	...
	if (EntryBox_0 != nullptr)
		*EntryBox_0 = Parms.EntryBox_0;
}
