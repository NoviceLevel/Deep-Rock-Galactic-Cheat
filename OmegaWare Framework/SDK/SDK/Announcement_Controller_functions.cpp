...
void UAnnouncement_Controller_C::Do_Resource_Full(const class FText& Name_0)
{
	static class UFunction* Func = nullptr;
...
// const struct FLinearColor&              Icon_Tint                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UAnnouncement_Controller_C::CreateValueAnnouncement(float Value, const class FText& Name_0, const struct FLinearColor& Color, int32 FractionalDigits, class UTexture2D* Icon, const struct FLinearColor& Icon_Tint)
{
	static class UFunction* Func = nullptr;
