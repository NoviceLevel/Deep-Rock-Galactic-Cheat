...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UModioTermsWrapper*               Terms_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UDialog_Modding_TermsAndConditions_C::ShowTerms(class UModioTermsWrapper* Terms_0)
{
	static class UFunction* Func = nullptr;
