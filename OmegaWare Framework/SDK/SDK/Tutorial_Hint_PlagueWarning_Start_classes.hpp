...
// BlueprintGeneratedClass Tutorial_Hint_PlagueWarning_Start.Tutorial_Hint_PlagueWarning_Start_C
// 0x0020 (0x0190 - 0x0170)
class UTutorial_Hint_PlagueWarning_Start_C final : public UTutorialHintComponent
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("Tutorial_Hint_PlagueWarning_Start_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"Tutorial_Hint_PlagueWarning_Start_C")
	}
	static class UTutorial_Hint_PlagueWarning_Start_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTutorial_Hint_PlagueWarning_Start_C>();
	}
};
DUMPER7_ASSERTS_UTutorial_Hint_PlagueWarning_Start_C;
