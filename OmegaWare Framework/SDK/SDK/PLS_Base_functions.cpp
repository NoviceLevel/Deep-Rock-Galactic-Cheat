...
// Parameters:
// int32                                   Seed_0                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const TArray<struct FRoomNode>&         Rooms_0                                                (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// const TArray<struct FPathObstacle>&     Obstacles                                              (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void APLS_Base_C::GenerateLandscapeFromData(int32 Seed_0, const TArray<struct FRoomNode>& Rooms_0, const TArray<struct FPathObstacle>& Obstacles)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Seed_0 = Seed_0;
	Parms.Rooms_0 = std::move(Rooms_0);
...
// Parameters:
// const struct FRoomNode&                 RoomNode                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// Parameters:
// TArray<class URoomGenerator*>&          Rooms_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
void APLS_Base_C::GetRandomRoom(TArray<class URoomGenerator*>& Rooms_0, bool RemoveRoom, class URoomGenerator** Room)
{
	static class UFunction* Func = nullptr;
	...
	Rooms_0 = std::move(Parms.Rooms_0);
