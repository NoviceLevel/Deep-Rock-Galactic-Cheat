...
// ESlateVisibility                        FALSE_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// ESlateVisibility                        TRUE_0                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ULIB_Game_C::SelectVisibility(class UWidget* Widget, ESlateVisibility FALSE_0, ESlateVisibility TRUE_0, bool Index_0, class UObject* __WorldContext, bool* IsVisible, bool* VisibilityChanged, ESlateVisibility* New_Visibility)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const struct FSoftObjectPath&           NewParam                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool*                                   IsFlaggedVisible_0                                     (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void ULIB_Game_C::IsFlaggedVisible(class UWidget* InWidget, class UObject* __WorldContext, bool* IsFlaggedVisible_0)
{
	static class UFunction* Func = nullptr;
	...
	if (IsFlaggedVisible_0 != nullptr)
		*IsFlaggedVisible_0 = Parms.IsFlaggedVisible_0;
}
