...
// const TArray<class UPerkAsset*>&        TargetArray                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// class UPerkAsset**                      Perk                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UITM_Loadout_PerksEquip_C::GetEquippedPerkAt(int32 Index_0, const TArray<class UPerkAsset*>& TargetArray, class UPerkAsset** Perk)
{
	static class UFunction* Func = nullptr;
