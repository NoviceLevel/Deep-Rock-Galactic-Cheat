...
void UHUD_FlareIcon_C::OnFlareCountChanged(int32 CurrentCount, class UInventoryComponent* Inventory_0)
{
	static class UFunction* Func = nullptr;
...
void UHUD_FlareIcon_C::Init(int32 Param_Index_0, class UInventoryComponent* Inventory_0)
{
	static class UFunction* Func = nullptr;
