...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const int32                             ReviveCount                                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class ABosco*                           Bosco_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UHUD_TeamDisplay_Bosco_C::OnBoscoChanged(class ABosco* Bosco_0)
{
	static class UFunction* Func = nullptr;
