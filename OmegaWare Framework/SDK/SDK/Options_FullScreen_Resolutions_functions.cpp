...
void UOptions_FullScreen_Resolutions_C::BndEvt__Basic_OptionSwitcher_K2Node_ComponentBoundEvent_20_OnSelectionChanged__DelegateSignature(const class FText& Value, int32 Index_0)
{
	static class UFunction* Func = nullptr;
