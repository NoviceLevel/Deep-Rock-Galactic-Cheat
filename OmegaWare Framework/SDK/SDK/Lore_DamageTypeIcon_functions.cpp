...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FDamageTypeDescription&    DamageType_0                                           (BlueprintVisible, BlueprintReadOnly, Parm)

void ULore_DamageTypeIcon_C::SetData(const struct FDamageTypeDescription& DamageType_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DamageType_0 = std::move(DamageType_0);
