...
// Parameters:
// uint8                                   State_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UABP_DrunksBox_C::OnStateChanged_Event_0(uint8 State_0)
{
	static class UFunction* Func = nullptr;
...
void UABP_DrunksBox_C::AnimGraph(struct FPoseLink* AnimGraph_0)
{
	static class UFunction* Func = nullptr;
