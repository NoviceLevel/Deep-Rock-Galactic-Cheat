...
// bool                                    ShowRequiredAmount_0                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UUI_HorizontalResourceBar_C::AddResourceCustom(class UResourceData* InResource, float InAmount, float InRequiredAmount, bool IconOnRight, bool ShowRequiredAmount_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ShowRequiredAmount_0 = ShowRequiredAmount_0;
...
// Parameters:
// const TMap<class UResourceData*, int32>&InResources                                            (BlueprintVisible, BlueprintReadOnly, Parm)
