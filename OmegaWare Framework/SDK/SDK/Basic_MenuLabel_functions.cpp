...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// ENUM_CarbonTypeface                     Typeface_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBasic_MenuLabel_C::SetTypeFace(ENUM_CarbonTypeface Typeface_0)
{
	static class UFunction* Func = nullptr;
