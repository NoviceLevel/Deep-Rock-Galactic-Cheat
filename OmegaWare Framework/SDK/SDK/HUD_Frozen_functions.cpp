...
// Parameters:
// const TArray<EThawInputDirection>&      Inputs                                                 (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   CurrentProgress_0                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UHUD_Frozen_C::SetProgress(float CurrentProgress_0)
{
	static class UFunction* Func = nullptr;
