...
// Parameters:
// const TArray<class FString>&            OptionalModsToSetup                                    (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// const TArray<class FString>&            OptionalModsToEnable                                   (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// (HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// const TArray<class FString>&            ModsToEnable_0                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// const TArray<class FString>&            ModsToInstall_0                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UWND_JoiningModded_C::OnOptionalModsFetched(const TArray<class FString>& ModsToEnable_0, const TArray<class FString>& ModsToInstall_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ModsToEnable_0 = std::move(ModsToEnable_0);
	Parms.ModsToInstall_0 = std::move(ModsToInstall_0);
...
void UWND_JoiningModded_C::OnRequiredModsFetched(const TArray<class FString>& ModsToEnable_0, const TArray<class FString>& ModsToInstall_0)
{
	static class UFunction* Func = nullptr;
...
void UWND_JoiningModded_C::SetSession(const struct FBlueprintSessionResult& Session_0)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const TArray<class FString>&            ModIds                                                 (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// const class FString&                    ParentMod                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
